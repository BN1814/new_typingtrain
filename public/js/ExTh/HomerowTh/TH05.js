const randomText = [
    "เ เเ ด้ เ เเ ด้ เด้ เด้ เด้ เด้ ด้ เ เเ ด้ เ เเ เดเด เดเด เดเด เดเด ด้ด้ ด้ด้ ด้ด้ ด้ด้ เด เด เด เด",
    "เดเด เดเด เดเด เดเด ด้ด้ ด้ด้ ด้ด้ ด้ด้ เด เด เด เด เ เเ ด้ เ เเ ด้ เด้ เด้ เด้ เด้ ด้ เ เเ ด้ เ เเ",
    "ด้ด้ ด้ด้ ด้ด้ ด้ด้ เด เด เด เด เ เเ ด้ เ เเ ด้ เ เเ ด้ เด้เด้ เด้เด้ เด เด เด้เด้ เด้เด้ เด เด ด้ เด้"
];
