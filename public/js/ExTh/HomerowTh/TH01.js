const randomText = [
    "ดดดด ด่ด่ด่ด่ ดดดด ด่ด่ด่ด่ ด่ด่ด่ด่ ด่ด่ด่ด่ ด่ด่ด่ด่ ด่ด่ด่ด่ ด่ด่ด่ด่ ดดดด ด่ด่ด่ด่ ดดดด ด่ดดด่ ด่ดดด่ ด่ดดด่ ด่ดดด่ ด่ด่ดด ด่ด่ดด ด่ด่ดด ด่ด่ดด ",
    "ด่ดดด่ ด่ดดด่ ด่ดดด่ ด่ดดด่ ด่ด่ดด ด่ด่ดด ด่ด่ดด ด่ด่ดด ด่ด่ด่ด ด่ด่ด่ด ด่ด่ด่ด ด่ด่ด่ด ดดดด ด่ด่ด่ด่ ดดดด ด่ด่ด่ด่ ด่ด่ด่ด่ ด่ด่ด่ด่ ด่ด่ด่ด่ ด่ด่ด่ด่ ",
    "ด่ด่ดด ด่ด่ดด ด่ด่ดด ด่ด่ดด ด่ด่ด่ด ด่ด่ด่ด ด่ด่ด่ด ด่ด่ด่ด ดดดด ด่ด่ด่ด่ ดดดด ด่ด่ด่ด่ ดดดด ด่ด่ด่ด่ ด่ดด่ด่ ด่ดด่ด่ ดด่ด่ด่ ดด่ด่ด่ ด่ดด่ด่ ด่ดด่ด่ ",
];
