const randomText = [
    "ดดดด ดดดด ดดดด ดดดด ด่ด่ ด่ด่ ด่ด่ ด่ด่ ด่ ด่ ด่ ด่ ด่ด่ ด่ด่ ด่ด่ ด่ด่ ด่ด่ด่ ด่ด่ด่ ด่ด่ด่ ด่ด่ด่ ดด่ด่ ดด่ด่ ดด่ด่ ดด่ด่ ด่ด่ด่ ด่ด่ด่ ด่ด่ด่ ด่ด่ด่",
    "ดดด ดดดด ดดดด ดดดด ด่ด่ด่ ด่ด่ด่ ด่ด่ด่ ด่ด่ด่ ดด่ด่ ดด่ด่ ดด่ด่ ดด่ด่ ด่ด่ด่ ด่ด่ด่ ด่ด่ด่ ด่ด่ด่ ด่ด่ ด่ด่ ด่ด่ ด่ด่ ด่ ด่ ด่ ด่ ด่ด่ ด่ด่ ด่ด่ ด่ด่",
