const randomText = [
    "ไไไไ ไไไไ ไไไไ ไไไไ นนนน นนนน นนนน นนนน ไไนน ไไนน ไไนน ไไนน นนไไ นนไไ นนไไ นนไไ ไนไน ไนไน ไนไน ไนไน นไนไ นไนไ นไนไ นไนไ ไไไน ไไไน ไไไน ไไไน นไไไ นไไไ นไไไ นไไไ",
    "นนนน นนนน นนนน นนนน ไไไไ ไไไไ ไไไไ ไไไไ นไไไ นไไไ นไไไ นไไไ ไไไน ไไไน ไไไน ไไไน นไนไ นไนไ นไนไ นไนไ ไนไน ไนไน ไนไน ไนไน นนไไ นนไไ นนไไ นนไไ ไไนน ไไนน ไไนน ไไนน",
    "ไไไน ไไไน ไไไน ไไไน นนนไ นนนไ นนนไ นนนไ ไนไน ไนไน นไนไ นไนไ ไไนน ไไนน ไไนน ไไนน นนไไ นนไไ นนไไ นนไไ ไไไไ นนนน ไไไไ นนนน ไไไไ นนนน ไไไไ นนนน นไนไ นไนไ ไนไน ไนไน"
];
