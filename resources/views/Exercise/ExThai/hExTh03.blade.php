    ...
    <body>  
        ...
        <div class="container">
                ...
                <div class="col-sm-4 col-md-2">
                    <div class="card" style="width: 150px; height: 150px;">
                        ...
                        <div class="card-body"> 
                            ...
                            <a href="{{ route('E-TH25')}}" class="btn btn-primary position-absolute bottom-10 start-50 translate-middle-x" style="width: 94%; height: 25%;" >เริ่ม</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-md-2">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-md-2">
                    <div class="card" style="width: 150px; height: 150px;">
                        <div class="card-header">ระดับที่ 37</div>
                        <div class="card-body"> 
                            <p class="fs-4 text-center">ฌ และ _็</p>
                            <a href="{{ route('TEST02')}}" class="btn btn-primary position-absolute bottom-10 start-50 translate-middle-x" style="width: 94%; height: 25%;" >เริ่ม</a>
                        </div>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center position-absolute bottom-0 start-50 translate-middle-x">
                    <li class="page-item">
                    <a class="page-link" href="{{ route('hExTH02')}}">Previous</a>
                    </li>
                    ...
                    <li class="page-item">
                    <a class="page-link" href="{{ route('hExTH04')}}">Next</a>
                    </li>
                </ul>
            </nav>
        </div>
