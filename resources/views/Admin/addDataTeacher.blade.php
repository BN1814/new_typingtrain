...
@section('content')
    ...
    <style>
        * {
        ...
        .add-admin-teacher .head-add-teacher {
            background: #333;
            width: 100%;
            height: 50px;
            text-align: center;
        ...
        .add-admin-teacher .head-add-teacher p {
            color: #fff;
            line-height: 50px;
            font-size: 18px;
            font-weight: bold;
        }
        .add-admin-teacher .body-add-teacher {
            width: 100%;
            height: auto;
            background: transparent;
        }
        .add-admin-teacher form {
            width: 100%;
            height: auto;
            text-align: center;
            display: block;
        }
        .add-admin-teacher form label {
            font-size: 16px;
            font-weight: 500;
        }
        .add-admin-teacher form input {
            width: 300px;
            height: 30px;
            border-radius: 5px;
            border: 0;
        ...
        .add-admin-teacher form input:focus {
    ...
    <body>
        ...
        <div class="main-addTeacher">
            <div class="add-admin-teacher">
                <div class="head-add-teacher">
                    <p>เพิ่มข้อมูลอาจารย์</p>
                </div>
                <div class="body-add-teacher">
                    <form action="#" method="#">
                        <div class="email">
